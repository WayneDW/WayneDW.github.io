...
## Sample trajectory
CSGLD possesses a self-adjusting mechanism to escape local traps. Most notably, it leads to **smaller or even negative learning rates in low energy regions to bounce particles out of local regions**. 
