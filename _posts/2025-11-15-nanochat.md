...
\begin{align}
    ...
    &\text{Tokens per step (T/s): } 8 \times 64 \times 2048 \approx 10^6 \notag \\
    &\text{Compute per step: FLOPs/token \times Tokens per step} \approx 6 \times 10^{15} \notag \\
...
if we assume 1 iteration per second.
...
{% raw %}
```bibtex
@article{deng2025nanochat,
  title   ={{Practical Notes on Training NanoChat}},
  author  ={Wei Deng},
  journal ={waynedw.github.io},
  year    ={2025},
  url     ="https://weideng.org/nanochat-training"
}
```
{% endraw %}