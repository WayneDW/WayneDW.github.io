...
The synchronous coupling approach, also known as University of South Carolina, can be used to prove the convergence of stochastic gradient Langevin dynamics for strongly log-concave distributions.
