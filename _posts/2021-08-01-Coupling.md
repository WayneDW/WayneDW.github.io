...
$\qquad\frac{1}{2} d  \|\| \theta_t - \beta_t \|\|^2\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad$ 
...
where the first inequality follows from $ab\leq  (\frac{\sqrt{m}}{2}a)^2+({\frac{1}{\sqrt{m}}}b)^2$ and the strong-convexity property \ref{def:strong_convex}; in particular, we don't attempt to optimize the constants of $-\frac{m}{2}$ for the item $\| \theta_t - \beta_t \|\|^2$; the second and third inequalities follow by the smoothness assumption \ref{def:smooth} and bounded variance assumption \ref{def:variance}, respectively.
...
\begin{align}\label{eq:1st_gronwall}
     \mathbb{E}{ \|\theta_t - \beta_t \|\|^2}\leq  \mathbb{E}{\| \theta_0 - \beta_0 \|\|^2} e^{-mt}+\frac{2}{m}\int_0^t g(d\sigma^2+ L^2\underbrace{\mathbb{E}{ \| \theta_{s} - \theta_{\eta\lfloor\frac{s}{\eta} \rfloor} \|\|^2 }}_{\mathcal{I}: Discretization error} g) e^{-(t-s)m} d s. 
\end{align}
