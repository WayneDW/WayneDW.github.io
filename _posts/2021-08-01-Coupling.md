...
\begin{align}
\label{def}
\forall A\in \mathcal{X}, \quad \|p-q\|_{TV}=\sup_{A\in \mathcal{X}},
\end{align}


$\mathbb{P}(X\in A)- P(Y\in A)=P(X\in A \cap X\neq Y)- P(Y\in A \cap X\neq Y)\leq P(X\neq Y)$.
