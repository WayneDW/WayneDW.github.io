...
\begin{align}
\label{def}
\forall A\in \mathcal{X}, \quad \|p-q\|_{TV}=\sup_{A\in \mathcal{X}} P(X\in A)- P(Y\in A)\leq P(X\neq Y),
\end{align}
...
$$\|p-q\|_{TV}=\sup_{A\in \mathcal{X}} P(X\in A)- P(Y\in A)$$
$$\quad\ \ =\frac{1}{2}\int |p(x)- q(x)| d x$$
$$\qquad\qquad=1-\int \min\{p(x), q(x)\} d x$$
