...
A coupling of two random variables/ vectors represents a joint distribution, where the first marginal distribution is $p$ and the second one is $q$ and any joint distribution is a coupling of the joint distributions.
