...
**Theorem** Assume assumptions \ref{def:strong_convex}, \ref{def:smooth}, and \ref{def:variance} hold. For any learning rate $\eta \in (0 , \min\{1, {m}/{L^2}\})$ and $|\theta_0-\theta_*|_2\leq \sqrt{d} D$ and $\theta_*$ is a stationary point. Then
