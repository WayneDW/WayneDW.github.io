...
\begin{align}
\label{def}
\forall A\in \mathcal{X}, \quad \|p-q\|_{TV}=\sup_{A\in \mathcal{X}} \mathbb{P}(X\in A)- \mathbb{P}(Y\in A)\leq \mathbb{P}(X\neq Y),
\end{align}
...
Recall from Eq.(\ref{def}) that $\sup_{A\in \mathcal{X}} \mathbb{P}(X\in A)- \mathbb{P}(Y\in A)=\sup_{A\in \mathcal{X}}\nu(A)=\nu(D)=\mathbb{P}(X\in D)-\mathbb{P}(Y\in D)$. We have 
...
$$\|p-q\|_{TV}=\sup_{A\in \mathcal{X}} \mathbb{P}(X\in A)- \mathbb{P}(Y\in A)$$
