...
Maximal coupling is closely related to the total variation distance.

\begin{align}
\label{def}
\forall A\in \mathcal{X}, \quad \|p-q\|_{\text{TV}}=\sup_{A\in \mathcal{X}} P(X\in A)- P(Y\in A),
\end{align}
...
$$\forall A\in \mathcal{X}, \quad \|p-q\|_{\text{TV}},$$
...
Recall from Eq.(\ref{def}) that $\sup_{A\in \mathcal{X}} P(X\in A)- P(Y\in A)=\sup_{A\in \mathcal{X}}\nu(A)=\nu(D)=P(X\in D)-P(Y\in D)$. We have 
$$P(X\in D)-P(Y\in D)=\int_{\{x:\ p(x)\geq q(x)\}} p(x) d x - \int_{\{y:\ p(x) \geq q(x)\}} q(x) d x$$

$$\qquad\qquad\qquad\qquad\qquad\ =\int_{\{x:\ p(x)< q(x)\}} q(x) d x - \int_{\{y:\ p(x) < q(x)\}} p(x) d x.$$
...
$$\|p-q\|_{\text{TV}}=\frac{1}{2}\int |p(x)- q(x)| d x$$.
$$\qquad\qquad\qquad\quad=1-\int \min\{p(x), q(x)\} d x.$$

In the end, we can summarize the different formulations of total variation
$$\|p-q\|_{\text{TV}}=\sup_{A\in \mathcal{X}} P(X\in A)- P(Y\in A)\qquad\qquad\qquad\qquad\qquad\qquad$$
$$\quad\ \ =\frac{1}{2}\int |p(x)- q(x)| d x\qquad\qquad\qquad\qquad\qquad\qquad\qquad$$
