...
\begin{align}\label{eq:1st_gronwall}
     \E{ \|\theta_t - \beta_t \|\|^2}\leq  \E{\| \theta_0 - \beta_0 \|\|^2} e^{-mt}+\frac{2}{m}\int_0^t g(d\sigma^2+ L^2\underbrace{\E{ \| \theta_{s} - \theta_{\eta\lfloor\frac{s}{\eta} \rfloor} \|\|^2 }}_{\mathcal{I}} g) e^{-(t-s)m} d s. 
\end{align}
...
\begin{align}
    \E{ \|\| \theta_t - \beta_t \|\|^2 }&\leq  \E{\| \theta_0 - \beta_0 \|\|^2} e^{-mt}+\frac{2d}{m} (\sigma^2+L^2 G\eta) \int_0^t  e^{-(t-s)m} d s\\
     &\leq \E{\| \theta_0 - \beta_0 \|^2} e^{-mt}+\frac{2d}{m^2} (\sigma^2+L^2 G\eta).
\end{align}
...
\begin{align}
W_2(\mu_k, \pi) 
%\leq \left(\E{ \| \theta_{k\eta} - \beta_{k\eta} \|^2}\right)^{1/2}
