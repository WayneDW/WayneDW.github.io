...
Stochastic volatility (SV) models are popular in finance to model the heteroskedasticity in financial asset returns to hedge risks {% cite SMC_eco_survey %}. Consider a SV model {% cite doucet2011tutorial %} 
