...
I am an ML Researcher at Morgan Stanley. My interest is to leverage the deep learning progress to accelerate sampling, diffusion, filtering, and transport. The applications include Bayesian inference, generative models, financial time series (e.g. asset pricing), and computer vision.


I actively contribute to open-source projects such as [Contour Sampler in JAX](https://github.com/blackjax-devs/blackjax), supporting sampling on JAX-GPUs. I ever led [NLP in Finance](https://github.com/WayneDW/Sentiment-Analysis-in-Event-Driven-Stock-Price-Movement-Prediction) in 2016 and [DeepLight in Ad Serving](https://github.com/WayneDW/DeepLight_Deep-Lightweight-Feature-Interactions) in 2019.
...
Apr, 2023. NewBeginnings: One ICML on [diffusion models and Schrodinger bridge](https://arxiv.org/pdf/2305.07247) is accepted!
