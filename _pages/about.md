...
Apr, 2024. [Reflected Schrödinger Bridge](https://arxiv.org/pdf/2401.03228) is accepted by UAI'24 as **Oral** (<3% acceptance rate). Reflected Schrödinger inherits the linear convergence of couplings via entropic optimal transport on bounded domains.
